...
When(
  'User fills all the required fields {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}, {string}',
  function (
    concern: string,
    ...
    this.newEpisode_page.fillPersonInformation(
      firstName,
      lastName,
      middleName,
      preferredName,
...
When('User submit the episode', function () {
  this.newEpisode_page.closeSearch();
  this.newEpisode_page.fillNotesAndSubmit();
});
